...
public class NbrsJoursOuvresBean extends AbstractBean<AbstractDTO, NbrsJoursOuvresBean> {
    ...
    @NotNull
    @Override
    public NbrsJoursOuvresBean fromDto(@NotNull AbstractDTO dto) throws BeanException {
        return null; // FIXME FDA 2017/08
    }
}
